...
The vault contains a fixed set of ratings (default 1000) that are NEVER used for
...
class TrainingManifest:
    ...
    Example:
        ...
        train_files, val_files, vault_files = manifest.split_with_vault(
            all_rated_files, train_ratio=0.8, vault_size=1000
        )
    ...
    def split_with_vault(
        ...
        Args:
            ...
            vault_size: Number of files to reserve for A/B testing (default 1000)
