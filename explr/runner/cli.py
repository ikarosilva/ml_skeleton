"""
Command-line interface for the explr framework.
...
@click.group()
@click.version_option(version="0.1.0", prog_name="explr")
def cli():
    """
...
def run(config_path: str, train_fn: str, override: tuple):
    ...
    from explr.runner.experiment import run_experiment
...
def memory(limit: Optional[float], show: bool):
    ...
    """
    from explr.utils.memory import limit_gpu_memory, print_memory_summary
